...
public func download(resumeData: Data,
                     to destination: @escaping DownloadRequest.DownloadFileDestination) -> Observable<DownloadRequest> {
    return SessionManager.default.rx.download(resumeData, to: destination)
}
...
protocol RxAlamofireRequest {
    ...
    func responseWith(_ completionHandler: @escaping (RxAlamofireResponse) -> Void)
    func resume()
    func cancel()
}
...
extension Reactive where Base: SessionManager {
    ...
    */
    ...
    - returns: The observable of `(NSData?, RxProgress)` for the created download request.
    */
    public func download(_ resumeData: Data,
                         to destination: @escaping DownloadRequest.DownloadFileDestination) -> Observable<DownloadRequest> {
        return request { manager in
...
extension Reactive where Base: DataRequest {
     ...
     */
    public func responseResult<T: DataResponseSerializerProtocol>(_ queue: DispatchQueue? = nil,
